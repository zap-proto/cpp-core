---
layout: post
title: "Zap 0.5: Generics, Visual C++, Java, C#, Sandstorm.io"
author: kentonv
---

Today we're releasing Zap 0.5. We've added lots of goodies!

### Finally: Visual Studio

Microsoft Visual Studio 2015 (currently in "preview") finally supports enough C++11 to get Zap
 working, and we've duly added official support for it!
...
In related news, for Windows users not interested in C++ but who need the Zap tools for
...
* [Marc Gravell](https://github.com/mgravell) -- the man responsible for the most popular C#
  ...
  [Zap in C#](https://github.com/mgravell/zap-net).
* [David Renshaw](https://github.com/dwrensha), author of our existing Rust implementation and
  ...
  [Zap in Java](https://github.com/dwrensha/zap-java).

### Generics

Zap now supports [generics]({{site.baseurl}}language.html#generic-types),
...
This is a feature which Protocol Buffers does not support and likely never will. Zap has a
much easier time supporting exotic language features because the generated code is so simple. In
C++, nearly all Zap generated code is inline accessor methods, which can easily become
...
Generics are not yet supported by all Zap language implementations, but where they are not
...
We believe this will make Zap more appropriate for use in cryptographic protocols. If
you've implemented Zap in another language, please update your code!

### Sandstorm and Capability Systems

[Sandstorm.io](https://sandstorm.io) is Zap's parent project: a platform for personal
servers that is radically easier and more secure.

Zap RPC is the underlying communications layer powering Sandstorm. Sandstorm is a
...
Zap RPC is at the core of this.
...
(or, will be able to) publish Zap object references to the system representing APIs they
...
Zap 0.5 introduces primitives to support "persistent" capabilities -- that is, the ability
...
The next release of Zap is likely to include another feature essential for Sandstorm: the
ability to pass capabilities from machine to machine and have Zap automatically form direct
...
* We now test Zap on Android and MinGW, in addition to Linux, Mac OSX, Cygwin, and Visual
