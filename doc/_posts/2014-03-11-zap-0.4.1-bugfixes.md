---
layout: post
title: "Zap 0.4.1: Bugfix Release"
author: kentonv
---

Today I'm releasing [version 0.4.1 of Zap](https://zap.org/zap-c++-0.4.1.tar.gz).
...
interesting project built on Zap which should launch by the end of this month.
...
In the meantime, though, there have been some major updates from the community:
  ...
  * The folks at [Cloudflare](https://www.cloudflare.com/) have produced a
    [Lua port](https://github.com/cloudflare/lua-zap) which they are
    [using successfully in production](http://blog.cloudflare.com/introducing-lua-zap-better-serialization-in-lua)
    along with the existing [Go port](https://github.com/jmckaskill/go-zap).
  * [The Rust port of Zap](https://github.com/dwrensha/zap-rust) now has
    preliminary RPC support, making it the third language to support Zap RPC (after
  ...
  * A [JavaScript port](https://github.com/jscheid/zap-js) has appeared, but it needs help
    to keep going!
