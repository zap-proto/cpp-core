...
Most Zap and KJ users are unlikely to have this functionality enabled and so unlikely to be affected. We suspect only [the Cloudflare Workers Runtime][0] is affected.
...
- KJ HTTP is an optional library bundled with Zap, but is not directly used by Zap. If you haven't heard of it, you probably aren't using it.
...
- This functionality first appeared in Zap 1.0. Previous versions are not affected.
...
- release 1.0.1.1:
  - Unix: https://zap.org/zap-c++-1.0.1.1.tar.gz
  - Windows: https://zap.org/zap-c++-win32-1.0.1.1.zip

[1]: https://github.com/zap/zap/commit/e7f22da9c01286a2b0e1e5fbdf3ec9ab3aa128ff
[2]: https://github.com/zap/zap/commit/75c5c1499aa6e7690b741204ff9af91cce526c59

Details
=======

KJ is a C++ toolkit library that evolved along with the Zap C++ implementation. While it originally contained only a few utilities used by Zap itself, it has grown over time with quite a few features. One of the larger features is an HTTP/1.1 implementation, complete with WebSocket support. KJ's HTTP library is used by the Cloudflare Workers runtime.
